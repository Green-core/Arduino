...
void loop(){
  if(WiFi.status()==WL_CONNECTED){ //Check WiFi connection status
    ...
    http.begin("http://192.168.8.100:3002/units/get-actuator-status");  //get actuator status - wether the actuators should be activated or not
